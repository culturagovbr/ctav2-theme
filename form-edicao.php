  ...
  <div id="post">
    <?php if(have_posts()) : the_post(); ?>
      ...
      <div class="entry">
        ...
        // Edição
        $edicao_tempo_bruto                = $Validator->Validate($_POST['edicao_tempo_bruto'], "Tempo Bruto", "max_length=2000");
        $edicao_tempo_ilha                 = $Validator->Validate($_POST['edicao_tempo_ilha'], "Tempo Ilha", "max_length=2000");
        $edicao_periodo_edicao             = $Validator->Validate($_POST['edicao_periodo_edicao'], "Período de Edição", "max_length=2000");
        ...
        $filme_servico                     = $Validator->Validate($_POST['filme_servico'], "Servico", "max_length=100");
        ...
        if(!empty($_POST['accept']) && !empty($_POST['submit']) && !is_array($erros)) :
          $form_count = get_option('form_edicao_count');
          ...
          "
            ...
            <table width='100%' border='0' cellspacing='0' class='forms'>
              ...
              <!-- Edição -->
              <th colspan='4' bgcolor='#eaf4eb' align='center'>4. SOBRE A EDIÇÃO</th>
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Tempo do material bruto:</th>
                <td>{$edicao_tempo_bruto}</td>
                <th align='right'>Tempo estimado de ilha:</th>
                <td>{$edicao_tempo_ilha}</td>
              </tr>
              <tr>
                <th align='right'>Período sugerido para edição:</th>
                <td colspan='3'>{$edicao_periodo_edicao}</td>
              </tr>
              <tr>
                <td colspan='4'>&nbsp;</td>
              </tr>
          ...
          $to = "edicaoctav@gmail.com";
          $subject = "CTAv: Edição {$form_count}";
          ...
          if(mail($to, $subject, $message, $headers)) :
            update_option('form_edicao_count', $form_count);
        ...
        ?>
          ...
          <form action="" method="post">
            ...
            <table width='100%' border='0' cellspacing='0' class='forms'>
              ...
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Tempo do material bruto:</th>
                <td><input type="text" name="edicao_tempo_bruto" maxlength="100" value="<?php print $edicao_tempo_bruto; ?>" /></td>
                <th align='right'>Tempo estimado de ilha:</th>
                <td><input type="text" name="edicao_tempo_ilha" maxlength="100" value="<?php print $edicao_tempo_ilha; ?>" /></td>
              </tr>
              <tr>
                <th align='right'>Período sugerido para edição:</th>
                <td colspan='3'><input type="text" name="edicao_periodo_edicao" maxlength="100" value="<?php print $edicao_periodo_edicao; ?>" /></td>
              </tr>
              <tr>
                <td colspan='4'>&nbsp;</td>
              </tr>
