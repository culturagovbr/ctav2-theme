...
// The code below is to fix drop down menus in IE so that they don't hide behind
// select boxes and iframes
...
addEvent(listMenu, 'show',  function(mN) { setTimeout(this.myName + '.ieSelBoxFixShow("' + mN  + '")', 1) }, 1);
