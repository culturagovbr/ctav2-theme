<?php 
/*
  Template Name: Mixagem com Técnico Credenciado
*/
?>
  ...
  <div id="post">
    <?php if(have_posts()) : the_post(); ?>
      ...
      <div class="entry">	  
        ...
        $proponente_ddd_celular            = $Validator->Validate($_POST['proponente_ddd_celular'], "DDD Celular", "numeric=1&length=2");
        $proponente_celular                = $Validator->Validate($_POST['proponente_celular'], "Celular", "numeric=1&max_length=15");
        ...
        else
        {
          ...
          $diretor_ddd_celular             = $Validator->Validate($_POST['diretor_ddd_celular'], "DDD Celular do Diretor", "numeric=1&length=2");
          $diretor_celular                 = $Validator->Validate($_POST['diretor_celular'], "Celular do Diretor", "numeric=1&max_length=15");
        ...
        // Mixagem
        $mixagem_finalizacao               = $Validator->Validate($_POST['mixagem_finalizacao'], "Finalização", "required=1&max_length=5");
        $mixagem_inicio                    = $Validator->Validate($_POST['mixagem_inicio'], "Início da Mixagem", "required=1&length=10");
        $mixagem_termino                   = $Validator->Validate($_POST['mixagem_termino'], "Término da Mixagem", "required=1&length=10");
        $mixagem_mixador_nome              = $Validator->Validate($_POST['mixagem_mixador_nome'], "Nome do mixador a ser credenciado", "required=1&max_length=100");
        $mixagem_mixador_ctav              = $Validator->Validate($_POST['mixagem_mixador_ctav'], "Numero CTAV do Mixador", "max_length=100");
        $mixagem_mixador_curriculo         = $Validator->Validate($_POST['mixagem_mixador_curriculo'], "Curriculo do Mixador", "required=1&max_length=6000");
        $mixagem_mixador_cursos            = $Validator->Validate($_POST['mixagem_mixador_cursos'], "Cursos do Mixador", "required=1&max_length=1000");
        $mixagem_mixador_experiencia       = $Validator->Validate($_POST['mixagem_mixador_experiencia'], "Experiência do Mixador", "required=1&max_length=500");

        // Filme
        $filme_titulo                      = $Validator->Validate($_POST['filme_titulo'], "Título do Filme", "required=1&max_length=100");
        $filme_ano                         = $Validator->Validate($_POST['filme_ano'], "Ano do Filme", "required=1&max_length=20");        
        ...
        $filme_valor                       = $Validator->Validate($_POST['filme_valor'], "Valor Orçado", "max_length=100");
        ...
        if(!empty($_POST['accept']) && !empty($_POST['submit']) && !is_array($erros)) :
          $form_count = get_option('form_mixagem_count');
          ...
          "
            ...
            <table width='100%' border='0' cellspacing='0' class='forms'>
              ...
              <!-- Mixagem -->
              <th colspan='4' bgcolor='#eaf4eb' align='center'>4. SOBRE A MIXAGEM</th>
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Finalização de som: *</th>
                <td colspan='3'>{$mixagem_finalizacao}</td>
              </tr>
              <tr>
                <th align='right' valign='top'>Período sugerido para Mixagem: *</th>
                <td>Início em: {$mixagem_inicio}</td>
                <td colspan='2'>Término em: {$mixagem_termino}</td>
              </tr>
              <tr>
                <td colspan='4'>&nbsp;</td>
              </tr>
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Nome do mixador a ser credenciado:</th>
                <td colspan='3'>{$mixagem_mixador_nome}</td>
              </tr>
              <tr>
                <th align='right'>Número CTAv do Mixador:</th>
                <td colspan='3'>{$mixagem_mixador_ctav}</td>
              </tr>
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Currículo resumido do Mixador:</th>
                <td colspan='3'>{$mixagem_mixador_curriculo}</td>
              </tr>
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Cursos do Mixador:</th>
                <td colspan='3'>{$mixagem_mixador_cursos}</td>
              </tr>
              <tr>
                <th align='right'>Experiência com o equipamento?</th>
                <td colspan='3'>{$mixagem_mixador_experiencia}</td>
              </tr>
              ...
              <tr>
                ...
                <td>{$filme_titulo}</td>
                <th align='right'>Ano do Filme:</th>
                <td>{$filme_ano}</td>
              </tr>
              <tr bgcolor='#f6f9fa'>
              ...
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Caso seja inscrito em leis federais de incentivo, informar número de Pronac ou Salic:</th>
          ...
          $to = "tecnicocredenciado@cultura.gov.br";
          $subject = "CTAv: Mixagem {$form_count}";
          ...
          if(mail($to, $subject, $message, $headers)) :
            update_option('form_mixagem_count', $form_count);
            
            $regulamento = new WP_Query('page_id=12182');
            ...
            print "<script>alert('ATENÇÃO: SUA INSCRIÇÃO (Nº {$form_count}) SÓ SERÁ CONSIDERADA APÓS O RECEBIMENTO DA DOCUMENTAÇÃO E DO MATERIAL COMPLEMENTAR ENVIADO VIA CORREIOS NO PRAZO PREVISTO NO REGULAMENTO. \\n CASO O MATERIAL NÃO CHEGUE AO CTAV O PROJETO SERÁ ELIMINADO DA SELEÇÃO. \\n NÃO SE ESQUEÇA DE IMPRIMIR SEU FORMULÁRIO!')</script>";
          else :
        ...
        ?>
          ...
          <h3 style="color: rgb(255, 0, 0);">ATENÇÃO: SUA INSCRIÇÃO SÓ SERÁ CONSIDERADA APÓS O RECEBIMENTO DA DOCUMENTAÇÃO E DO MATERIAL COMPLEMENTAR ENVIADO VIA CORREIOS NO PRAZO PREVISTO NO REGULAMENTO.</h3>
          <h3 style="color: rgb(255, 0, 0);">CASO O MATERIAL NÃO CHEGUE AO CTAV O PROJETO SERÁ ELIMINADO DA SELEÇÃO.</h3>
          <!-- <p><a href="http://www.ctav.gov.br/wp-content/uploads/2008/11/pre-requisitos_mixagem.pdf" title="Pré-requisitos para Mixagem">Pré-requisitos para Mixagem</a></p> -->
          <form id='form_principal' action="" method="post">
            ...
            <table width='100%' border='0' cellspacing='0' class='forms'>
              ...
              <tr bgcolor='#f6f9fa'>              
                ...
                <td colspan='3'>                  
                  ...
                  <input type='radio' name='projeto_metragem' value='longa' <?php if($projeto_metragem == 'longa') print "checked='checked'"; ?> /> Longa-metragem<br /><br />
              ...
              <tr bgcolor='#f6f9fa'>
                <th align='right' valign='top'>Finalização de som: *</th>
                <td colspan='3'>
                  <input type='radio' name='mixagem_finalizacao' value='dolby' <?php if($mixagem_finalizacao == 'dolby') print "checked='checked'"; ?> /> Dolby<br />
                  <input type='radio' name='mixagem_finalizacao' value='mono' <?php if($mixagem_finalizacao == 'mono') print "checked='checked'"; ?> /> Mono<br />
                </td>
              </tr>
              <tr>
                <th align='right' valign='top'>Período sugerido para Mixagem: *</th>
                <td>Início em: <input type='text' name='mixagem_inicio' size='10' maxlength='10' value='<?php print $mixagem_inicio; ?>' /></td>
                <td colspan='2'>Término em: <input type='text' name='mixagem_termino' size='10' maxlength='10' value='<?php print $mixagem_termino; ?>' /></td>
              </tr>
              <tr bgcolor='#f6f9fa'>
                <th align='right' valign='top'>Nome do mixador a ser credenciado: *</th>
                <td colspan='3'><input type="text" name="mixagem_mixador_nome" maxlength="100" value="<?php print $mixagem_mixador_nome; ?>" /></td>
              </tr>               
              <tr>
                <th align='right' valign='top'>Número de credenciamento do Mixador junto ao CTAv (Se já possuir):</th>
                <td colspan='3'><input type="text" name="mixagem_mixador_ctav" maxlength="100" value="<?php print $mixagem_mixador_ctav; ?>" /></td>
              </tr> 
              <tr bgcolor='#f6f9fa'>
                <th align='right' valign='top'>Currículo do profissional responsável pela Mixagem: * <br />
                                 (Explicitar dados dos filmes em que já trabalhou e a função exercida em cada um)</th>
                <td colspan='3'>
                  <textarea id='mixagem_mixador_curriculo' name='mixagem_mixador_curriculo' cols='75' rows='10'><?php print $mixagem_mixador_curriculo; ?></textarea>
                  <small id="mixagem_mixador_curriculo_limit">max. 6000 caracteres</small>
                </td>
              </tr>             
              <tr bgcolor='#f6f9fa'>
                <th align='right' valign='top'>O mixador participou de cursos, oficinas ou workshops para utilizar os equipamentos de mixagem do CTAV? Se sim, especifique: *</th>
                <td colspan='3'>
                  <textarea id='mixagem_mixador_cursos' name='mixagem_mixador_cursos' cols='50' rows='5'><?php print $mixagem_mixador_cursos; ?></textarea>
                </td>
              </tr>
              <tr>
                <th align='right' valign='top'>O Mixador possui experiência profissional com o equipamento de mixagem do CTAV? *</th>
                <td colspan='3'><input type="text" name="mixagem_mixador_experiencia" maxlength="100" value="<?php print $mixagem_mixador_experiencia; ?>" /></td>
              </tr> 
              ...
              <tr>
                <th align='right'>Título do Filme: *</th>
                <td><input type="text" name="filme_titulo" maxlength="100" value="<?php print $filme_titulo; ?>" /></td>
                <th align='right'>Ano do Filme: *</th>
                <td><input type="text" name="filme_ano" maxlength="100" value="<?php print $filme_ano; ?>" />
                </td>
              </tr>
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Universitário: *</th>
            ...
            <input type="submit" name="submit" id='btn_submit' value="enviar" />
          </form>
        
        <?php else : ?>
          <form action="" method="post">
            <?php $regulamento = new WP_Query('page_id=12182'); ?>
