  ...
  <div id="post">
    <?php if(have_posts()) : the_post(); ?>
      ...
      <div class="entry">
        ...
        // Mixagem
        $mixagem_servico                   = $Validator->Validate($_POST['mixagem_servico'], "Serviço", "required=1&max_length=50");
          ...
          "
            ...
            <table width='100%' border='0' cellspacing='0' class='forms'>
              ...
              <tr>
                ...
                <td colspan='3'>{$mixagem_servico}</td>
              </tr>
              <tr bgcolor='#f6f9fa'>
        ...
        ?>
          ...
          <p><a href="http://homolog.cultura.gov.br/ctav/wp-content/uploads/2008/11/pre-requisitos_mixagem.pdf" title="Pré-requisitos para Mixagem">Pré-requisitos para Mixagem</a></p>
          <form action="" method="post">
            ...
            <table width='100%' border='0' cellspacing='0' class='forms'>
              ...
              <th colspan='4' bgcolor='#eaf4eb' align='center'>4. SOBRE A MIXAGEM</th>
              <tr>
                <th align='right' valign='top'>Serviço solicitado: *</th>
                <td colspan='3'>
                  <input type='radio' name='mixagem_servico' value='mixagem' <?php if($mixagem_servico == 'mixagem') print "checked='checked'"; ?> /> Mixagem<br />
                  <input type='radio' name='mixagem_servico' value='visionamento_de_mixagem' <?php if($mixagem_servico == 'visionamento_de_mixagem') print "checked='checked'"; ?> /> Visionamento de Mixagem<br />
                </td>
              </tr>
              <tr bgcolor='#f6f9fa'>
