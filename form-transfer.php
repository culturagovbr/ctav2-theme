  ...
  <div id="post">
    <?php if(have_posts()) : the_post(); ?>
      ...
      <div class="entry">
        ...
        // Transfer
        $transfer_24p                       = $Validator->Validate($_POST['transfer_24p'], "Foi gravado em 24p", "required=1&length=1");
        
        // Filme
        $filme_titulo                      = $Validator->Validate($_POST['filme_titulo'], "Título do Filme", "required=1&max_length=100");
        $filme_ano                         = $Validator->Validate($_POST['filme_ano'], "Ano do Filme", "required=1&numeric=1&length=4&min_value=1900&max_value=2010");
        ...
        if(!empty($_POST['accept']) && !empty($_POST['submit']) && !is_array($erros)) :
          $form_count = get_option('form_transfer_count');
          ...
          "
            ...
            <table width='100%' border='0' cellspacing='0' class='forms'>
              ...
              <!-- Transfer -->
              <th colspan='4' bgcolor='#eaf4eb' align='center'>4. SOBRE O TRANSFER</th>
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Foi gravado em 24p? *</th>
                <td colspan='3'>{$transfer_24p}</td>
              </tr>
              <tr>
                <td colspan='4'>&nbsp;</td>
              </tr>
          ...
          $to = "transferctav@gmail.com";
          $subject = "CTAv: Transfer {$form_count}";
          ...
          if(mail($to, $subject, $message, $headers)) :
            update_option('form_transfer_count', $form_count);
        ...
        ?>
          ...
          <p><a href="http://www.ctav.gov.br/wp-content/uploads/2008/11/pre-requisitos_transfer_curtas.pdf" title="Pré-requisitos para Transfer de curtas">Pré-requisitos para Transfer de curtas</a></p>
          <p><a href="http://www.ctav.gov.br/wp-content/uploads/2008/11/pre-requisitos_transfer_medias_e_longas.pdf" title="Pré-requisitos para Transfer de médias e longas">Pré-requisitos para Transfer de médias e longas</a></p>
          <form action="" method="post">
            ...
            <table width='100%' border='0' cellspacing='0' class='forms'>
              ...
              <th colspan='4' bgcolor='#eaf4eb' align='center'>4. SOBRE O TRANSFER</th>
              <tr bgcolor='#f6f9fa'>
                <th align='right' valign='top'>Foi gravado em 24p? *</th>
                <td colspan='3'>
                  <input type='radio' name='transfer_24p' value='s' <?php if($transfer_24p == 's') print "checked='checked'"; ?> /> Sim 
                  <input type='radio' name='transfer_24p' value='n' <?php if($transfer_24p == 'n') print "checked='checked'"; ?> /> Não
                </td>
              </tr>
              <tr>
                <td colspan='4'>&nbsp;</td>
              ...
              <tr>
                ...
                <th align='right'>Ano do Filme: *</th>
                <td><input type="text" name="filme_ano" size="4" maxlength="4" value="<?php print $filme_ano; ?>" /></td>
              </tr>
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Universitário: *</th>
                <td>
