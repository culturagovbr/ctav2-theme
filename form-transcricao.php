<?php 
/*
  Template Name: Transcrição de Som
*/
?>
  ...
  <div id="post">
    <?php if(have_posts()) : the_post(); ?>
      ...
      <div class="entry">
        ...
        // Transcrição
        $transcricao_tempo_bruto           = $Validator->Validate($_POST['transcricao_tempo_bruto'], "Tempo Bruto", "required=1&max_length=100");
        $transcricao_tempo_material        = $Validator->Validate($_POST['transcricao_tempo_material'], "Tempo do Material", "required=1&max_length=100");
        $transcricao_suporte_original      = $Validator->Validate($_POST['transcricao_suporte_original'], "Suporte Original", "required=1&max_length=100");
        $transcricao_suporte_material      = $Validator->Validate($_POST['transcricao_suporte_material'], "Suporte Transcrição", "required=1&max_length=100");
        $transcricao_conservacao           = $Validator->Validate($_POST['transcricao_conservacao'], "Estado de Conservação", "required=1&max_length=10");
        ...
        if(!empty($_POST['accept']) && !empty($_POST['submit']) && !is_array($erros)) :
          $form_count = get_option('form_transcricao_count');
          ...
          "
            ...
            <table width='100%' border='0' cellspacing='0' class='forms'>
              ...
              <!-- Transcrição -->
              <th colspan='4' bgcolor='#eaf4eb' align='center'>4. SOBRE O MATERIAL A SER TRANSCRITO</th>
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Tempo de duração bruto: *</th>
                <td>{$transcricao_tempo_bruto}</td>
                <th align='right'>Tempo do material a ser transcrito: *</th>
                <td>{$transcricao_tempo_material}</td>
              </tr>
              <tr>
                <th align='right'>Suporte Original: *</th>
                <td>{$transcricao_suporte_original}</td>
                <th align='right'>Suporte para transcrição: *</th>
                <td>{$transcricao_suporte_material}</td>
              </tr>
              <tr bgcolor='#f6f9fa'>
                <th align='right'>Tempo de duração bruto: *</th>
                <td colspan='3'>{$transcricao_conservacao}</td>
              </tr>
              <tr>
                <td colspan='4'>&nbsp;</td>
              </tr>
          ...
          $to = "transcricaoctav@gmail.com";
          $subject = "CTAv: Transcrição {$form_count}";
          ...
          if(mail($to, $subject, $message, $headers)) :
            update_option('form_transcricao_count', $form_count);
            
            $regulamento = new WP_Query('page_id=538');
        ...
        ?>
          ...
          <form action="" method="post">
            ...
            <table width='100%' border='0' cellspacing='0' class='forms'>
              ...
              <tr>
                <th align='right'>Tempo de duração bruto: *</th>
                <td><input type="text" name="transcricao_tempo_bruto" maxlength="100" value="<?php print $transcricao_tempo_bruto; ?>" /></td>
                <th align='right'>Tempo do material a ser transcrito: *</th>
                <td><input type="text" name="transcricao_tempo_material" maxlength='100' value="<?php print $transcricao_tempo_material; ?>" /></td>
              </tr>
              <tr>
                <th align='right'>Suporte original: *</th>
                <td><input type="text" name="transcricao_suporte_original" maxlength="100" value="<?php print $transcricao_suporte_original; ?>" /></td>
                <th align='right'>Suporte para transcricao: *</th>
                <td><input type="text" name="transcricao_suporte_material" maxlength='100' value="<?php print $transcricao_suporte_material; ?>" /></td>
              </tr>
              <tr>
                <th align='right'>Estado de conservação do material: *</th>
                <td colspan='3'>
                  <input type="radio" name="transcricao_conservacao" value="boa" <?php if($transcricao_consercacao == 'boa') print "checked='checked'"; ?> /> Boa 
                  <input type="radio" name="transcricao_conservacao" value="regular" <?php if($transcricao_consercacao == 'regular') print "checked='checked'"; ?> /> Regular 
                  <input type="radio" name="transcricao_conservacao" value="ruim" <?php if($transcricao_consercacao == 'ruim') print "checked='checked'"; ?> /> Ruim 
                  <input type="radio" name="transcricao_conservacao" value="nao sei" <?php if($transcricao_consercacao == 'nao sei') print "checked='checked'"; ?> /> Não sei 
                </td>
              </tr>
              <tr>
                <td colspan='4'>&nbsp;</td>
        ...
        <?php else : ?>
          <form action="" method="post">
            <?php $regulamento = new WP_Query('page_id=538'); ?>
